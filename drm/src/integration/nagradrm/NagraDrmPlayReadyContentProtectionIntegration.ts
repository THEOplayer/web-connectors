...
export class NagraDrmPlayReadyContentProtectionIntegration implements ContentProtectionIntegration {
    ...
    onCertificateRequest(request: CertificateRequest): MaybeAsync<Partial<CertificateRequest> | BufferSource> {
        request.headers = {
            ...request.headers,
            'nv-authorizations': this.contentProtectionConfiguration.integrationParameters.token,
