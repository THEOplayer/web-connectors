...
export const buildContentMetadata = (metadata: ComscoreMetadata): ns_.analytics.StreamingAnalytics.ContentMetadata => {
    ...
    if(deliveryAdvertisementCapability) {
        contentMetadata.setDeliveryAdvertisementCapability(mapDeliveryAdvertisementCapability(deliveryAdvertisementCapability))
    }
    if(mediaFormat) {
...
const mapDeliveryMode = (deliveryMode: ComscoreDeliveryMode): ns_.analytics.StreamingAnalytics.ContentMetadata.ContentDeliveryMode => {
    switch(deliveryMode){
...
const mapDeliverySubscriptionType = (deliverySubscriptionType: ComscoreDeliverySubscriptionType): ns_.analytics.StreamingAnalytics.ContentMetadata.ContentDeliverySubscriptionType => {
...
const mapDeliveryComposition = (deliveryComposition: ComscoreDeliveryComposition): ns_.analytics.StreamingAnalytics.ContentMetadata.ContentDeliveryComposition => {
...
const mapDeliveryAdvertisementCapability = (deliveryAdvertisementCapability: ComscoreDeliveryAdvertisementCapability): ns_.analytics.StreamingAnalytics.ContentMetadata.ContentDeliveryAdvertisementCapability => {
    switch(deliveryAdvertisementCapability){
        ...
        case ComscoreDeliveryAdvertisementCapability.dynamicReplacement:
            return ns_.analytics.StreamingAnalytics.ContentMetadata.ContentDeliveryAdvertisementCapability.DYNAMIC_REPLACEMENT
...
const mapMediaFormat = (mediaFormat: ComscoreMediaFormat): ns_.analytics.StreamingAnalytics.ContentMetadata.ContentMediaFormat => {
    switch(mediaFormat){
...
const mapDistributionModel = (distributionModel: ComscoreDistributionModel): ns_.analytics.StreamingAnalytics.ContentMetadata.ContentDistributionModel => {
